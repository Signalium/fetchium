...
const styles = {
  note: {
    ...
    title: 'text-secondary-300 mt-0 mb-2 uppercase text-xs font-semibold tracking-wider',
    body: 'text-primary-200 prose-code:text-primary-100',
  },
  warning: {
    container: 'border-l-2 border-tertiary-400 bg-tertiary-900/20',
    title: 'text-tertiary-400 mt-0 mb-2 uppercase text-xs font-semibold tracking-wider',
...
export function Callout({
  ...
  return (
    <div className={clsx('my-8 rounded-lg p-5', styles[type].container)}>
      <p className={clsx('m-0', styles[type].title)}>
        {title}
      </p>
