...
function highlight(line: string): ReactNode {
  ...
  if (!filtered.length)
    return <span style={{ color: C.text1 }}>{line || ' '}</span>;
      ...
      {label && (
        ...
        >
          <span
            ...
            style={{ background: C.pink, opacity: 0.6 }}
          />
          <span
            className="h-1.5 w-1.5 rounded-full"
          ...
          <span
            ...
            style={{ color: C.text3, fontFamily: F.code }}
          >
            {label}
          </span>
        </div>
...
function Tile({
  ...
  return (
    <div
      className="relative flex h-20 w-20 shrink-0 flex-col items-center justify-center rounded-md"
      style={{ background: C.bg2, border: `1px solid ${C.border}` }}
    >
      <span
        className="absolute top-1.5 left-2"
        style={{ fontSize: 8, fontFamily: F.label, color: cm.fg, opacity: 0.8 }}
      >
        {number}
      </span>
      <span
...
function FeatureTile({
  ...
  return (
    ...
    >
      <div
        className="relative flex h-16 w-16 shrink-0 flex-col items-center justify-center rounded-md"
      ...
      <div className="min-w-0 flex-1">
        <div
          ...
          style={{ color: C.text0, fontFamily: F.label }}
        >
          {title}
        </div>
        <p
          className="m-0 text-xs leading-relaxed"
          style={{ color: C.text2, fontFamily: F.body }}
        >
          {desc}
        </p>
      </div>
...
export function FetchiumHome() {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      <section className="mx-auto max-w-6xl px-10 pt-16 pb-6">
        <div className="mb-12 text-center">
          ...
          <p
            ...
            style={{ color: C.text2, lineHeight: 1.7 }}
          >
            Type-safe queries with entity normalization, fine-grained
            reactivity, and streaming — for REST APIs and beyond.
          </p>
        </div>
          ...
          <div className="hidden shrink-0 lg:block">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* Fc hero tile */}
                <div
                  className="relative flex h-28 w-24 shrink-0 flex-col items-center justify-center rounded-md"
        ...
        <div className="mt-10 flex items-center justify-center gap-3">
          ...
          <Link
            href="/quickstart"
            className="rounded-lg border-none px-5 py-2.5 text-sm font-medium text-white"
        ...
        >
          REST-first. Protocol-agnostic. Built on{' '}
          <span style={{ color: C.green }}>Signalium</span>. Works with React,
          Vue, Svelte, and more.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-10 py-16">
        <h2
          ...
          style={{ fontSize: 26, fontWeight: 500, fontFamily: F.label }}
        >
          The elements of Fetchium
        </h2>
        <p
          className="mx-auto mb-10 max-w-lg text-center"
          style={{ fontSize: 14, color: C.text2, lineHeight: 1.6 }}
        >
          Everything you need for production data fetching, nothing you
          don&apos;t.
        </p>
      ...
      {/* Entity normalization */}
      <section
        className="mx-auto max-w-6xl px-10 py-16"
      ...
      >
        <div className="flex flex-col items-start gap-12 lg:flex-row">
          <div className="shrink-0 lg:max-w-[340px]">
            <h2
              className="mb-3"
              style={{ fontSize: 22, fontWeight: 500, fontFamily: F.label }}
            >
            ...
            <p
              ...
              style={{ color: C.text1 }}
            >
              When the same user appears in a post and a profile, Fetchium
              returns the <em>exact same object</em>. Update it anywhere, see it
              everywhere — no manual cache invalidation.
            </p>
            <div
            ...
            >
              <span
                ...
                style={{ color: C.green, fontFamily: F.label }}
              >
                Identity stable
              </span>
              <p
                ...
                style={{ color: C.text1 }}
              >
                Entity proxies backed by signals. Lazy entanglement means you
            ...
            >
              <span
                className="text-xs font-medium"
                style={{ color: C.pink, fontFamily: F.label }}
              >
                Works with React
              </span>
              <p
                ...
                style={{ color: C.text1 }}
              >
                Deep cloning with structural sharing at the React boundary.
                Compatible with memo, compiler, and Suspense.
              </p>
            </div>
          </div>
          <div className="flex min-w-0 flex-1 flex-col gap-2.5">
        ...
        <div className="flex flex-col-reverse items-start gap-12 lg:flex-row">
          ...
          <div className="shrink-0 lg:max-w-[340px]">
            ...
            <p
              ...
              style={{ color: C.text1 }}
            >
              Fetchium&apos;s type system is designed for resilience. Optional
              fields fall back to undefined. Arrays silently filter unknown
              types. Your app keeps running while the API evolves.
            </p>
            <p className="text-sm leading-relaxed" style={{ color: C.text2 }}>
              The type DSL uses number masks under the hood — not objects. A
              type like{' '}
              <code
      ...
      <section
        ...
        style={{ borderTop: `1px solid ${C.border}`, background: C.bg0 }}
      >
        <div className="mx-auto max-w-4xl">
          <h2
            className="mb-6 text-center"
            style={{ fontSize: 20, fontWeight: 500, fontFamily: F.label }}
          >
            What you get
          </h2>
          <div
          ...
          >
            <table className="w-full border-separate border-spacing-0 rounded-none! border-0! bg-transparent!">
              <thead>
                <tr>
                  {['', 'Fetchium', 'TanStack Query', 'Apollo Client'].map(
                    (h, i) => (
                      <th
                        key={h || 'e'}
      ...
      <section className="px-10 py-16 text-center">
        <h2
          className="mb-3"
          style={{ fontSize: 28, fontWeight: 500, fontFamily: F.label }}
        >
          Start fetching
        </h2>
        ...
        <div className="inline-flex gap-3">
          ...
          <Link
            href="/quickstart"
            className="rounded-lg border-none px-6 py-3 text-sm font-medium text-white"
            style={{ background: C.pink, fontFamily: F.label }}
          >
            Read the docs
          </Link>
        ...
        <div className="mt-8 flex justify-center gap-6">
          {[
            ...
            >
              ...
              <span
                style={{ fontSize: 13, color: C.text2, fontFamily: F.label }}
              >
                {n}
              </span>
            </Link>
      ...
      >
        <div className="flex items-center gap-2">
          <span style={{ fontSize: 13, color: C.text3, fontFamily: F.label }}>
            fetchium
          </span>
